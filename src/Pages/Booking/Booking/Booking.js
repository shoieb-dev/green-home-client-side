            ...
            <Container>
                ...
                <Row className="py-3 my-2 rounded-3">
                    <Col xs={1} md={6} lg={8} className="bg-light pt-2">
                        <img className="w-100 pb-3 rounded-3" src={house.img1} alt="" />
                        <div>
                    ...
                    <Col xs={1} md={6} lg={4}>
                        ...
                        <div className="add-house py-5 mb-5 text-center text-white h-100">
                            ...
                            <form className="" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input defaultValue={house.name} {...register("house", { required: true })} />

                                <input defaultValue={house.price} {...register("price", { required: true })} />

                                <input placeholder="Phone Number" defaultValue="" {...register("phone", { required: true })} />

                                <input type="submit" value="Book This Apartment" className="btn-outline-success" />
                            </form>
                        </div>
                    </Col>
                </Row>
